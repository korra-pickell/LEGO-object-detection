...
def camera_view_bounds_2d(scene, camera_object, mesh_object):
    ...
    r#eturn (int(min_x*bpy.context.scene.render.resolution_x), int(min_y*bpy.context.scene.render.resolution_y)),(int(max_x*bpy.context.scene.render.resolution_x), int(max_y*bpy.context.scene.render.resolution_y))
...
if __name__ == '__main__':
    ...
    print(camera_view_bounds_2d(scene, camera_object, mesh_object))